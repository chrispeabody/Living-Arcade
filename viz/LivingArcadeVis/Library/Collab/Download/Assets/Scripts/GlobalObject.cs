...
public class GlobalObject : MonoBehaviour {
    ...
    public List<ObjectRecipe> recipes = new List<ObjectRecipe>();
...
public class ObjectRecipe
{
    ...
    public string id;
    public Dictionary<string, string> triggers = new Dictionary<string, string>{{ "A1", "SetXSpeed(.1)" } };
    ...
    {
        string[] numsStr = Regex.Split(str, @"\D+");
